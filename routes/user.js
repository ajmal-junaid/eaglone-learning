...
const { userLogin, userSignup, verifyEmail } = require('../controllers/user');
const { getAllCourses, getFreeCourses, getCourseByCategoryName, getPaidCourses } = require('../controllers/course');
